...
function select_default(select) {
  ...
  for (
    ...
    for (
      ...
      if (
        (node2 = group2[i]) &&
        (subnode = select.call(node2, node2.__data__, i, group2))
      ) {
...
function selectChildren_default(match2) {
  return this.selectAll(
    match2 == null
      ? children
      : childrenFilter(
          typeof match2 === "function" ? match2 : childMatcher(match2)
        )
  );
}
...
function filter_default(match2) {
  ...
  for (
    ...
    for (
      ...
      if (
        (node2 = group2[i]) &&
        match2.call(node2, node2.__data__, i, group2)
      ) {
        subgroup.push(node2);
      }
    }
...
function data_default(value, key) {
  ...
  var bind2 = key ? bindKey : bindIndex,
...
function arraylike(data2) {
  return typeof data2 === "object" && "length" in data2
    ? data2
    : Array.from(data2);
}
...
function order_default() {
  for (var groups2 = this._groups, j = -1, m = groups2.length; ++j < m; ) {
    for (
      var group2 = groups2[j], i = group2.length - 1, next2 = group2[i], node2;
      --i >= 0;
...
function rgb(r, g, b, opacity2) {
  return arguments.length === 1
    ? rgbConvert(r)
    : new Rgb(r, g, b, opacity2 == null ? 1 : opacity2);
}
function Rgb(r, g, b, opacity2) {
  this.r = +r;
  this.g = +g;
...
function hsl(h, s2, l, opacity2) {
  return arguments.length === 1
    ? hslConvert(h)
    : new Hsl(h, s2, l, opacity2 == null ? 1 : opacity2);
}
function Hsl(h, s2, l, opacity2) {
  this.h = +h;
  this.s = +s2;
...
function lab(l, a2, b, opacity2) {
  return arguments.length === 1
    ? labConvert(l)
    : new Lab(l, a2, b, opacity2 == null ? 1 : opacity2);
}
function Lab(l, a2, b, opacity2) {
  this.l = +l;
  this.a = +a2;
...
function hcl(h, c4, l, opacity2) {
  return arguments.length === 1
    ? hclConvert(h)
    : new Hcl(h, c4, l, opacity2 == null ? 1 : opacity2);
}
function Hcl(h, c4, l, opacity2) {
  this.h = +h;
  this.c = +c4;
...
function cubehelix(h, s2, l, opacity2) {
  return arguments.length === 1
    ? cubehelixConvert(h)
    : new Cubehelix(h, s2, l, opacity2 == null ? 1 : opacity2);
}
function Cubehelix(h, s2, l, opacity2) {
  this.h = +h;
  this.s = +s2;
...
var InternMap = class extends Map {
  constructor(entries2, key = keyof) {
    ...
    if (entries2 != null)
      for (const [key2, value] of entries2) this.set(key2, value);
  }
  get(key) {
...
function max(values2, valueof) {
  ...
  if (valueof === void 0) {
    for (const value of values2) {
      if (
        value != null &&
        (max6 < value || (max6 === void 0 && value >= value))
      ) {
        max6 = value;
      }
    }
...
function quantileSorted(values2, p, valueof = number) {
  ...
  var n,
    i = (n - 1) * p,
    i0 = Math.floor(i),
    value0 = +valueof(values2[i0], i0, values2),
    value1 = +valueof(values2[i0 + 1], i0 + 1, values2);
  return value0 + (value1 - value0) * (i - i0);
}
...
function tween_default(name, value) {
  ...
  return this.each(
    (value == null ? tweenRemove : tweenFunction)(id3, name, value)
  );
}
...
function ease_default(value) {
  var id3 = this._id;
  return arguments.length
    ? this.each(easeConstant(id3, value))
    : get2(this.node(), id3).ease;
}
...
var Path = class {
  ...
  moveTo(x3, y3) {
    this._append`M${(this._x0 = this._x1 = +x3)},${(this._y0 = this._y1 =
      +y3)}`;
  }
  closePath() {
    if (this._x1 !== null) {
  ...
  bezierCurveTo(x12, y1, x22, y22, x3, y3) {
    this._append`C${+x12},${+y1},${+x22},${+y22},${(this._x1 =
      +x3)},${(this._y1 = +y3)}`;
  }
  arcTo(x12, y1, x22, y22, r) {
    ...
    if (this._x1 === null) {
      ...
      this._append`A${r},${r},0,0,${+(y01 * x20 > x01 * y20)},${(this._x1 =
        x12 + t21 * x21)},${(this._y1 = y1 + t21 * y21)}`;
    }
  }
  arc(x3, y3, r, a0, a1, ccw) {
    ...
    if (da2 > tauEpsilon) {
      this._append`A${r},${r},0,1,${cw},${x3 - dx},${
        y3 - dy
      }A${r},${r},0,1,${cw},${(this._x1 = x02)},${(this._y1 = y0)}`;
    } else if (da2 > epsilon) {
      this._append`A${r},${r},0,${+(da2 >= pi3)},${cw},${(this._x1 =
        x3 + r * Math.cos(a1))},${(this._y1 = y3 + r * Math.sin(a1))}`;
    }
  }
  rect(x3, y3, w, h) {
    this._append`M${(this._x0 = this._x1 = +x3)},${(this._y0 = this._y1 =
...
function addAll(data2) {
  ...
  for (i = 0; i < n; ++i) {
    if (
      isNaN((x3 = +this._x.call(null, (d = data2[i])))) ||
...
function remove_default3(d) {
  ...
  while (node2.data !== d)
    if (!((previous = node2), (node2 = node2.next))) return this;
    ...
    for (var i = 0; i < 4; ++i) {
      if ((child = node2.source[i])) {
        if (child.length)
          nodes.push({
            source: child,
            target: (node2.target[i] = new Array(4)),
          });
...
function formatDecimalParts(x3, p) {
  if (
    (i = (x3 = p ? x3.toExponential(p - 1) : x3.toExponential()).indexOf("e")) <
    0
  )
    return null;
  var i,
  ...
  function newFormat(specifier) {
    ...
    function format2(value) {
        ...
        if (maybeSuffix) {
          ...
          while (++i < n) {
            if (((c4 = value.charCodeAt(i)), 48 > c4 || c4 > 57)) {
              valueSuffix =
                (c4 === 46 ? decimal + value.slice(i + 1) : value.slice(i)) +
                valueSuffix;
      ...
      var length2 = valuePrefix.length + value.length + valueSuffix.length,
        padding =
          length2 < width ? new Array(width - length2 + 1).join(fill3) : "";
      if (comma && zero3)
        (value = group2(
          padding + value,
...
function polygonContains_default(polygon, point6) {
    ...
    for (
      ...
      sum4.add(
        atan2(
          ...
          cosPhi0 * cosPhi1 + k2 * cos2(absDelta)
        )
      );
  ...
  return (
    (angle < -epsilon5 || (angle < epsilon5 && sum4 < -epsilon22)) ^
    (winding & 1)
  );
}
...
function compareIntersection(a2, b) {
  return (
    ((a2 = a2.x)[0] < 0 ? a2[1] - halfPi3 - epsilon5 : halfPi3 - a2[1]) -
    ((b = b.x)[0] < 0 ? b[1] - halfPi3 - epsilon5 : halfPi3 - b[1])
  );
}
...
function clipAntimeridianLine(stream) {
  ...
  return {
    ...
    point: function (lambda1, phi1) {
      var sign1 = lambda1 > 0 ? pi4 : -pi4,
        delta = abs3(lambda1 - lambda0);
      if (abs3(delta - pi4) < epsilon5) {
        stream.point(
          lambda0,
          (phi0 = (phi0 + phi1) / 2 > 0 ? halfPi3 : -halfPi3)
        );
...
function clipAntimeridianIntersect(lambda0, phi0, lambda1, phi1) {
  var cosPhi0,
    cosPhi1,
    sinLambda0Lambda1 = sin2(lambda0 - lambda1);
  return abs3(sinLambda0Lambda1) > epsilon5
    ? atan(
        (sin2(phi0) * (cosPhi1 = cos2(phi1)) * sin2(lambda1) -
          sin2(phi1) * (cosPhi0 = cos2(phi0)) * sin2(lambda0)) /
...
function azimuthalRaw(scale3) {
  return function (x3, y3) {
    ...
    return [k2 * cy * sin2(x3), k2 * sin2(y3)];
  };
}
function azimuthalInvert(angle) {
  return function (x3, y3) {
    var z = sqrt(x3 * x3 + y3 * y3),
      c4 = angle(z),
      sc = sin2(c4),
      cc2 = cos2(c4);
...
function transformer2() {
  ...
  function scale3(x3) {
    return x3 == null || isNaN((x3 = +x3))
      ...
      : (
          output ||
          (output = piecewise2(domain.map(transform2), range3, interpolate))
        )(transform2(clamp(x3)));
  }
  scale3.invert = function (y3) {
    return clamp(
      untransform(
        (
          input ||
          (input = piecewise2(range3, domain.map(transform2), number_default))
        )(y3)
      )
    );
  };
...
function identity4(domain) {
  ...
  scale3.domain = scale3.range = function (_) {
    return arguments.length
      ? ((domain = Array.from(_, number3)), scale3)
      : domain.slice();
  };
  scale3.unknown = function (_) {
    return arguments.length ? ((unknown = _), scale3) : unknown;
...
function logp(base) {
  return base === Math.E
    ...
    : (base === 10 && Math.log10) ||
        (base === 2 && Math.log2) ||
        ((base = Math.log(base)), (x3) => Math.log(x3) / base);
}
function reflect(f) {
...
function symlogish(transform2) {
  var c4 = 1,
    scale3 = transform2(transformSymlog(c4), transformSymexp(c4));
  scale3.constant = function (_) {
    return arguments.length
      ? transform2(transformSymlog((c4 = +_)), transformSymexp(c4))
      : c4;
  };
  return linearish(scale3);
}
...
function quantile2() {
  ...
  function scale3(x3) {
    return x3 == null || isNaN((x3 = +x3))
      ? unknown
      : range3[bisect_default(thresholds, x3)];
  }
...
function threshold() {
  var domain = [0.5],
    ...
    n = 1;
  function scale3(x3) {
    return x3 != null && x3 <= x3
      ? range3[bisect_default(domain, x3, 0, n)]
      : unknown;
  }
  scale3.domain = function (_) {
    return arguments.length
      ? ((domain = Array.from(_)),
        (n = Math.min(domain.length, range3.length - 1)),
        scale3)
      : domain.slice();
  };
  scale3.range = function (_) {
...
function timeInterval(floori, offseti, count3, field) {
  ...
  interval2.range = (start2, stop, step) => {
    ...
    let previous;
    do
      range3.push((previous = /* @__PURE__ */ new Date(+start2))),
        offseti(start2, step),
        floori(start2);
  ...
  interval2.filter = (test2) => {
    return timeInterval(
      (date2) => {
        if (date2 >= date2)
          while ((floori(date2), !test2(date2))) date2.setTime(date2 - 1);
      },
      (date2, step) => {
        if (date2 >= date2) {
          if (step < 0)
...
function pad2(value, fill3, width) {
  ...
  return (
    sign3 +
    (length2 < width
      ? new Array(width - length2 + 1).join(fill3) + string
      : string)
  );
}
function requote(s2) {
...
function transformer3() {
  ...
  function scale3(x3) {
    return isNaN((x3 = +x3))
      ...
      : ((x3 =
          0.5 +
          ((x3 = +transform2(x3)) - t13) * (s2 * x3 < s2 * t13 ? k10 : k21)),
        interpolator(clamp ? Math.max(0, Math.min(1, x3)) : x3));
  }
  scale3.domain = function (_) {
    return arguments.length
      ? (([x02, x12, x22] = _),
        (t03 = transform2((x02 = +x02))),
...
function _regeneratorRuntime() {
  ...
  function wrap(innerFn, outerFn, self2, tryLocsList) {
    ...
    return (
      defineProperty4(generator, "_invoke", {
  ...
  var getProto = Object.getPrototypeOf,
    NativeIteratorPrototype = getProto && getProto(getProto(values2([])));
  ...
  return (
    ...
    defineProperty4(Gp, "constructor", {
...
var uncurryThisWithBind =
  NATIVE_BIND$3 && FunctionPrototype$3.bind.bind(call$j, call$j);
var functionUncurryThis = NATIVE_BIND$3
  ? uncurryThisWithBind
  : function (fn) {
      return function () {
...
var symbolConstructorDetection =
  ...
  !fails$s(function () {
    ...
    return (
      !$String$5(symbol2) ||
      !(Object(symbol2) instanceof Symbol) || // Chrome 38-40 symbols are not inherited from DOM collections prototypes to instances
...
var createWellKnownSymbol = USE_SYMBOL_AS_UID$1
  ...
  : (Symbol$3 && Symbol$3.withoutSetter) || uid$2;
var wellKnownSymbol$m = function (name) {
  if (!hasOwn$b(WellKnownSymbolsStore, name)) {
    WellKnownSymbolsStore[name] =
      NATIVE_SYMBOL && hasOwn$b(Symbol$3, name)
        ? Symbol$3[name]
...
var IS_HTMLDDA =
  typeof documentAll$2 == "undefined" && documentAll$2 !== void 0;
var documentAll_1 = {
  all: documentAll$2,
  IS_HTMLDDA,
};
...
var isCallable$o = $documentAll$1.IS_HTMLDDA
  ? function (argument) {
...
var isObject$j = $documentAll.IS_HTMLDDA
  ? function (it) {
...
var ordinaryToPrimitive$1 = function (input, pref) {
  ...
  if (
    ...
    !isObject$g((val = call$h(fn, input)))
  )
    return val;
  if (
...
objectDefineProperty.f = DESCRIPTORS$b
...
var CONFIGURABLE =
  EXISTS &&
  (!DESCRIPTORS$a ||
    (DESCRIPTORS$a && getDescriptor(FunctionPrototype$2, "name").configurable));
var functionName = {
  EXISTS,
  PROPER,
  CONFIGURABLE,
...
var weakMapBasicDetection =
  isCallable$h(WeakMap$3) && /native code/.test(String(WeakMap$3));
...
var createNonEnumerableProperty$6 = DESCRIPTORS$9
...
var CONFIGURABLE_LENGTH =
  ...
  !fails$o(function () {
    return (
      defineProperty$8(function () {}, "length", { value: 8 }).length !== 8
    );
  });
...
var classof$b = TO_STRING_TAG_SUPPORT$2
  ? classofRaw$1
  : function (it) {
      var O, tag, result;
      return it === void 0
        ...
        : CORRECT_ARGUMENTS
        ? classofRaw$1(O)
        : (result = classofRaw$1(O)) === "Object" && isCallable$e(O.callee)
        ? "Arguments"
        : result;
    };
var TO_STRING_TAG_SUPPORT$1 = toStringTagSupport;
var classof$a = classof$b;
var objectToString$2 = TO_STRING_TAG_SUPPORT$1
  ? {}.toString
  : function toString2() {
  ...
  : function getOwnPropertyDescriptor(O, P) {
      ...
      if (hasOwn$7(O, P))
        return createPropertyDescriptor$2(
          !call$f(propertyIsEnumerableModule$1.f, O, P),
          O[P]
        );
    };
...
var toLength$3 = function (argument) {
  return argument > 0
    ? min$2(toIntegerOrInfinity$2(argument), 9007199254740991)
    : 0;
};
...
var ownKeys$1 =
  ...
  function ownKeys(it) {
    ...
    return getOwnPropertySymbols
      ? concat$2(keys4, getOwnPropertySymbols(it))
      : keys4;
  };
...
var functionUncurryThisAccessor = function (object, key, method) {
  try {
    return uncurryThis$l(
      aCallable$8(Object.getOwnPropertyDescriptor(object, key)[method])
    );
  } catch (error) {}
};
...
var speciesConstructor$1 = function (O, defaultConstructor) {
  ...
  var S;
  return C3 === void 0 || isNullOrUndefined$5((S = anObject$b(C3)[SPECIES$5]))
    ? defaultConstructor
    : aConstructor(S);
};
...
var engineIsIosPebble =
  /ipad|iphone|ipod/i.test(userAgent$3) && typeof Pebble != "undefined";
...
var queueMicrotaskDescriptor = getOwnPropertyDescriptor$1(
  global$a,
  "queueMicrotask"
);
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$9(
  global$8.PromiseRejectionEvent
);
...
if (FORCED_PROMISE_CONSTRUCTOR$4) {
  ...
  Internal.prototype = defineBuiltIn$6(
    PromisePrototype,
    "then",
  ...
  newPromiseCapabilityModule$4.f = newPromiseCapability$1 = function (C3) {
    return C3 === PromiseConstructor || C3 === PromiseWrapper
      ? new OwnPromiseCapability(C3)
      : newGenericPromiseCapability(C3);
  };
  if (
    isCallable$8(NativePromiseConstructor$2) &&
...
var isArrayIteratorMethod$2 = function (it) {
  return (
    it !== void 0 &&
    (Iterators$4.Array === it || ArrayPrototype$1[ITERATOR$5] === it)
  );
};
...
var getIterator$2 = function (argument, usingIterator) {
  var iteratorMethod =
    arguments.length < 2 ? getIteratorMethod$2(argument) : usingIterator;
...
var iterate$6 = function (iterable, unboundFunction, options) {
  ...
  if (IS_RECORD) {
    ...
    if (isArrayIteratorMethod$1(iterFn)) {
      for (
        index2 = 0, length2 = lengthOfArrayLike$7(iterable);
        length2 > index2;
        index2++
      ) {
    ...
    race: function race(iterable) {
      ...
      var result = perform$1(function () {
        ...
        iterate$4(iterable, function (promise2) {
          call$8($promiseResolve, C3, promise2).then(
            capability.resolve,
            reject2
          );
        });
...
var NEW_ITERATOR_PROTOTYPE =
  !isObject$b(IteratorPrototype$2) ||
  fails$i(function () {
    var test2 = {};
...
var es_array_iterator = defineIterator$2(
  Array,
  "Array",
    ...
    allSettled: function allSettled(iterable) {
      ...
      var result = perform(function () {
        ...
        iterate$3(iterable, function (promise2) {
          ...
          var alreadyCalled = false;
          remaining++;
          call$5(promiseResolve2, C3, promise2).then(
            function (value) {
              if (alreadyCalled) return;
              alreadyCalled = true;
...
var createMethod$3 = function (CONVERT_TO_STRING) {
  return function ($this, pos) {
    ...
    return first < 55296 ||
      first > 56319 ||
      position2 + 1 === size ||
      (second2 = charCodeAt(S, position2 + 1)) < 56320 ||
      second2 > 57343
      ? CONVERT_TO_STRING
        ? charAt$4(S, position2)
        : first
      : CONVERT_TO_STRING
      ? stringSlice$4(S, position2, position2 + 2)
      : ((first - 55296) << 10) + (second2 - 56320) + 65536;
  };
};
var stringMultibyte = {
...
for (COLLECTION_NAME$1 in DOMIterables$1) {
  handlePrototype$1(
    global$6[COLLECTION_NAME$1] && global$6[COLLECTION_NAME$1].prototype,
    COLLECTION_NAME$1
  );
}
  ...
  { target: "Array", proto: true, forced: !HAS_SPECIES_SUPPORT$2 },
  {
    slice: function slice5(start2, end) {
      ...
      if (isArray$4(O)) {
        ...
        if (
          isConstructor$2(Constructor) &&
          (Constructor === $Array$3 || isArray$4(Constructor.prototype))
        ) {
          Constructor = void 0;
      ...
      result = new (Constructor === void 0 ? $Array$3 : Constructor)(
        max$2(fin5 - k2, 0)
      );
      for (n = 0; k2 < fin5; k2++, n++)
        if (k2 in O) createProperty$3(result, n, O[k2]);
      result.length = n;
      return result;
    },
  }
...
(function (module2) {
  ...
  EventEmitter2.prototype.removeListener = function removeListener(
    ...
    if (listeners.fn) {
      ...
      for (
        var i = 0, events = [], length2 = listeners.length;
        i < length2;
        i++
      ) {
        if (
...
var objectAssign =
  ...
  fails$g(function () {
    ...
    return (
      $assign({}, A5)[symbol2] !== 7 ||
      objectKeys$1($assign({}, B3)).join("") !== alphabet
    );
  })
    ? function assign(target, source) {
        ...
        while (argumentsLength > index2) {
          ...
          var keys4 = getOwnPropertySymbols
...
var objectIsExtensible =
  FAILS_ON_PRIMITIVES$1 || ARRAY_BUFFER_NON_EXTENSIBLE
...
(function (ScrollDirection2) {
  ...
  ScrollDirection2[(ScrollDirection2["SCROLL_BACKWARD"] = 1)] =
    "SCROLL_BACKWARD";
      ...
      value: function loadNewDomains(newDomainCollection) {
        ...
        if (
          __classPrivateFieldGet(
            this,
            _Navigator_instances,
            "m",
            _Navigator_isDomainBoundaryReached
          ).call(this, newDomainCollection, minDate, maxDate, direction)
        ) {
        ...
        __classPrivateFieldGet(
          ...
          _Navigator_instances,
          "m",
          _Navigator_setDomainsBoundaryReached
        ).call(
          this,
        ...
        if (direction === ScrollDirection.SCROLL_BACKWARD) {
          this.calendar.eventEmitter.emit("domainsLoaded", [
            domainCollection.min,
          ]);
      ...
      value: function jumpTo(date2, reset) {
        ...
        if (date2 < minDate) {
          return this.loadNewDomains(
            this.calendar.createDomainCollection(date2, minDate, false),
            ScrollDirection.SCROLL_BACKWARD
          );
        }
        if (reset) {
          return this.loadNewDomains(
            this.calendar.createDomainCollection(date2, options.options.range),
            minDate < date2
        ...
        if (date2 > maxDate) {
          return this.loadNewDomains(
            this.calendar.createDomainCollection(maxDate, date2, false),
            ScrollDirection.SCROLL_FORWARD
          );
        }
        return ScrollDirection.SCROLL_NONE;
...
(_Navigator_instances = /* @__PURE__ */ new WeakSet()),
  (_Navigator_isDomainBoundaryReached =
    function _Navigator_isDomainBoundaryReached2(
      newDomainCollection,
      minDate,
      maxDate,
      direction
  ...
  (_Navigator_setDomainsBoundaryReached =
    function _Navigator_setDomainsBoundaryReached2(
      lowerBound,
      upperBound,
      min5,
      max6
      ...
      if (max6) {
        ...
        this.calendar.eventEmitter.emit(
          _reached ? "maxDateReached" : "maxDateNotReached"
        );
...
var FORCED$2 =
  !IS_CONCAT_SPREADABLE_SUPPORT || !arrayMethodHasSpeciesSupport$1("concat");
$$b(
      ...
      for (i = -1, length2 = arguments.length; i < length2; i++) {
        ...
        if (isConcatSpreadable(E2)) {
          ...
          for (k2 = 0; k2 < len; k2++, n++)
            if (k2 in E2) createProperty$1(A5, n, E2[k2]);
        } else {
...
var mergeSort = function (array4, comparefn) {
  ...
  return length2 < 8
    ? insertionSort(array4, comparefn)
    : merge2(
        array4,
    ...
    },
    {
      ...
      value: function update(collection2, scrollDirection) {
        ...
        collection2.yankedDomains.forEach(function (domainKey) {
          exitingTotal +=
            _this.collection.get(domainKey)[
        ...
        collection2.yankedDomains.forEach(function (domainKey) {
          ...
          _this.collection.set(
            domainKey,
            Object.assign(Object.assign({}, coor), {
              x: verticalOrientation
                ? coor.x
                : coor.x + exitingTotal * scrollFactor,
              y: verticalOrientation
                ? coor.y + exitingTotal * scrollFactor
                : coor.y,
            })
          );
        });
        keys4.forEach(function (domainKey) {
          var w = __classPrivateFieldGet(
            _this,
            _DomainCoordinates_instances,
            "m",
            _DomainCoordinates_getWidth
          ).call(_this, domainKey);
          var h = __classPrivateFieldGet(
            _this,
            _DomainCoordinates_instances,
            "m",
            _DomainCoordinates_getHeight
          ).call(_this, domainKey);
          ...
          _this.collection.set(
            domainKey,
            Object.assign(Object.assign({}, _this.collection.get(domainKey)), {
              x: verticalOrientation ? 0 : x3,
              y: verticalOrientation ? y3 : 0,
              pre_x: verticalOrientation
                ? x3
                : x3 - exitingTotal * scrollFactor,
              pre_y: verticalOrientation
                ? y3 - exitingTotal * scrollFactor
                : y3,
              width: w,
              height: h,
...
(_DomainCoordinates_instances = /* @__PURE__ */ new WeakSet()),
  (_DomainCoordinates_getWidth = function _DomainCoordinates_getWidth2(d) {
    var _this$calendar$option2 = this.calendar.options.options,
      ...
      x3 = _this$calendar$option2.x,
      verticalOrientation = _this$calendar$option2.verticalOrientation;
    var columnsCount = this.calendar.templateCollection
      .get(subDomain.type)
      .columnsCount(d);
    var subDomainWidth =
  ...
  (_DomainCoordinates_getHeight = function _DomainCoordinates_getHeight2(d) {
    var _this$calendar$option3 = this.calendar.options.options,
      ...
      x3 = _this$calendar$option3.x,
      verticalOrientation = _this$calendar$option3.verticalOrientation;
    var rowsCount = this.calendar.templateCollection
      .get(subDomain.type)
      .rowsCount(d);
    var subDomainHeight =
  ...
  _createClass(DomainPainter2, [
    {
      ...
      value: function paint(scrollDirection, rootNode) {
        ...
        var promises = [];
        this.root = rootNode
          .selectAll(DEFAULT_SELECTOR$3)
          .data(this.calendar.domainCollection.keys, function (d) {
            return d;
          })
          .join(
            function (enter) {
              return enter
                ...
                .attr("class", function (d) {
                  return __classPrivateFieldGet(
                    _this,
                    _DomainPainter_instances,
                    "m",
                    _DomainPainter_getClassName
                  ).call(_this, d);
                })
                .call(function (enterSelection) {
                  return enterSelection
                    ...
                    .attr(
                      "class",
                      "".concat(DEFAULT_SELECTOR$3.slice(1), "-bg")
                    );
                })
                .call(function (enterSelection) {
            ...
            function (update) {
              return update
                ...
                .call(function (updateSelection) {
                  return promises.push(
                    updateSelection
                      .selectAll("".concat(DEFAULT_SELECTOR$3, "-bg"))
                      .transition(t)
                      .attr("width", function (d) {
                        return coor.get(d).inner_width;
                      })
...
(_DomainPainter_instances = /* @__PURE__ */ new WeakSet()),
  (_DomainPainter_getClassName = function _DomainPainter_getClassName2(d) {
    ...
    switch (this.calendar.options.options.domain.type) {
      ...
      case "day":
        classname += " d_"
          .concat(helper.date(), " dy_")
          .concat(helper.format("d") + 1);
        break;
      case "week":
...
var DomainCollection = (function () {
  function DomainCollection2(dateHelper, interval2, start2, range3) {
    ...
    if (interval2 && start2 && range3) {
      var ts = this.dateHelper
        .intervals(interval2, start2, range3, excludeEnd)
        .map(function (d) {
          return castArray(d);
        });
    ...
    if (this.collection.size > 0) {
      __classPrivateFieldGet(
        this,
        _DomainCollection_instances,
        "m",
        _DomainCollection_refreshKeys
      ).call(this);
    }
  }
  _createClass(DomainCollection2, [
    ...
    },
    {
      ...
      value: function merge3(newCollection, limit, createValueCallback) {
        ...
        newCollection.keys.forEach(function (domainKey, index2) {
          ...
          _this2.collection.set(
            domainKey,
            createValueCallback(domainKey, index2)
          );
          __classPrivateFieldGet(
            _this2,
            _DomainCollection_instances,
    ...
    },
    {
      ...
      value: function slice7() {
        ...
        if (this.keys.length > limit) {
          var keysToDelete = fromBeginning
    ...
    },
    {
      ...
      value: function fill3(data2, _ref, subDomainKeyExtractor) {
        ...
        var groupedRecords = this.groupRecords(
          data2,
          x3,
        ...
        this.keys.forEach(function (domainKey) {
          ...
          __classPrivateFieldGet(
            ...
            _DomainCollection_instances,
            "m",
            _DomainCollection_setSubDomainValues
          ).call(_this4, domainKey, records, y3, groupY, defaultValue);
        });
      },
    },
    {
    ...
    },
    {
      ...
      value: function groupValues(values2, groupFn) {
        ...
        if (typeof groupFn === "string") {
          if (
            cleanedValues.every(function (n) {
            ...
            switch (groupFn) {
              ...
              case "min":
                return (
                  Math.min.apply(Math, _toConsumableArray(cleanedValues)) ||
                  null
                );
              case "max":
                return (
                  Math.max.apply(Math, _toConsumableArray(cleanedValues)) ||
                  null
                );
              case "average":
                return cleanedValues.length > 0
                  ? cleanedValues.reduce(function (a2, b) {
                      return a2 + b;
...
(_DomainCollection_instances = /* @__PURE__ */ new WeakSet()),
  (_DomainCollection_setSubDomainValues =
    function _DomainCollection_setSubDomainValues2(
      domainKey,
      records,
      y3,
      groupY,
      ...
      this.get(domainKey).forEach(function (subDomain, index2) {
        ...
        if (records.hasOwnProperty(subDomain.t)) {
          value = _this6.groupValues(
            __classPrivateFieldGet(
              _this6,
              _DomainCollection_instances,
              "m",
              _DomainCollection_extractValues
            ).call(_this6, records[subDomain.t], y3),
            groupY
          );
        }
  ...
  (_DomainCollection_extractValues = function _DomainCollection_extractValues2(
    data2,
    y3
  ) {
  ...
  _createClass(DomainLabelPainter2, [
    {
      ...
      value: function paint(root3) {
        ...
        var _this$calendar$option = this.calendar.options.options.domain,
          ...
          type2 = _this$calendar$option.type;
        ...
        root3
          ...
          .join(
            function (enter) {
              return enter
                .append("text")
                .attr("class", DEFAULT_SELECTOR$2.slice(1))
                .attr("x", function (d) {
                  return __classPrivateFieldGet(
                    _this,
                    _DomainLabelPainter_instances,
                    "m",
                    _DomainLabelPainter_getX
                  ).call(_this, d);
                })
                .attr("y", function (d) {
                  return __classPrivateFieldGet(
...
(_DomainLabelPainter_instances = /* @__PURE__ */ new WeakSet()),
  (_DomainLabelPainter_textVerticalAlign =
    function _DomainLabelPainter_textVerticalAlign2() {
      var _this$calendar$option2 = this.calendar.options.options.domain.label,
        position2 = _this$calendar$option2.position,
        rotate = _this$calendar$option2.rotate;
      if (isVertical(position2)) {
        return "middle";
      }
      if (
        (rotate === "left" && position2 === "left") ||
        (rotate === "right" && position2 === "right")
      ) {
        return "bottom";
      }
      return "hanging";
  ...
  (_DomainLabelPainter_getX = function _DomainLabelPainter_getX2(d) {
    var _this$calendar$option3 = this.calendar.options.options.domain,
      ...
      position2 = _this$calendar$option4.position,
      textAlign = _this$calendar$option4.textAlign,
      offset = _this$calendar$option4.offset;
    var domainHorizontalLabelWidth =
      this.calendar.options.options.x.domainHorizontalLabelWidth;
    ...
    if (position2 === "right") {
      x3 += __classPrivateFieldGet(
        ...
        _DomainLabelPainter_instances,
        "m",
        _DomainLabelPainter_getDomainInsideWidth
      ).call(this, d);
    }
    if (textAlign === "middle") {
  ...
  (_DomainLabelPainter_getY = function _DomainLabelPainter_getY2(d) {
    var _this$calendar$option5 = this.calendar.options.options,
      ...
      position2 = _this$calendar$option7.position,
      offset = _this$calendar$option7.offset,
      padding = _this$calendar$option6.padding,
      x3 = _this$calendar$option5.x;
    var y3 = padding[Position.TOP] + x3.domainVerticalLabelHeight / 2;
    if (position2 === "bottom") {
      y3 += __classPrivateFieldGet(
        this,
        _DomainLabelPainter_instances,
        "m",
        _DomainLabelPainter_getDomainInsideHeight
      ).call(this, d);
    }
    return y3 + offset.y;
  }),
  (_DomainLabelPainter_getDomainInsideWidth =
    function _DomainLabelPainter_getDomainInsideWidth2(d) {
      var _this$calendar$option8 = this.calendar.options.options,
        ...
        domainHorizontalLabelWidth =
          _this$calendar$option8.x.domainHorizontalLabelWidth;
      var coordinates =
  ...
  (_DomainLabelPainter_getDomainInsideHeight =
    function _DomainLabelPainter_getDomainInsideHeight2(d) {
      var _this$calendar$option9 = this.calendar.options.options,
        domainVerticalLabelHeight =
          _this$calendar$option9.x.domainVerticalLabelHeight,
  ...
  (_DomainLabelPainter_domainRotate =
    function _DomainLabelPainter_domainRotate2(selection2) {
      var _this2 = this;
      var _this$calendar$option10 = this.calendar.options.options,
        ...
        position2 = _this$calendar$option11.position,
        x3 = _this$calendar$option10.x;
      var labelWidth = x3.domainHorizontalLabelWidth;
      switch (rotate) {
        case "right":
          selection2.attr("transform", function (d) {
            var domainWidth = __classPrivateFieldGet(
              _this2,
              _DomainLabelPainter_instances,
              "m",
              _DomainLabelPainter_getDomainInsideWidth
            ).call(_this2, d);
            var domainHeight = __classPrivateFieldGet(
              _this2,
              _DomainLabelPainter_instances,
              "m",
              _DomainLabelPainter_getDomainInsideHeight
            ...
            var s2 = [
              "rotate(90, ".concat(
                position2 === "right" ? domainWidth : labelWidth,
                ", 0)"
              ),
            ];
            switch (position2) {
              case "right":
                if (textAlign === "middle") {
                  s2.push(
                    "translate(".concat(domainHeight / 2 - labelWidth / 2, ")")
                  );
              ...
              case "left":
                if (textAlign === "start") {
                  ...
                  s2.push(
                    "translate(".concat(labelWidth / 2 + domainHeight / 2, ")")
                  );
                } else if (textAlign === "end") {
  ...
  _createClass(SubDomainPainter2, [
    {
      ...
      value: function paint(root3) {
        ...
        var subDomainSvgGroup = this.root
            ...
            function (enter) {
              return enter
                ...
                .call(function (selection2) {
                  return __classPrivateFieldGet(
                    _this,
                    _SubDomainPainter_instances,
                    "m",
                    _SubDomainPainter_setPositions
                  ).call(_this, selection2);
                })
        ...
        var _this$calendar$option = this.calendar.options.options.subDomain,
          radius2 = _this$calendar$option.radius,
          width = _this$calendar$option.width,
          height = _this$calendar$option.height,
          sort3 = _this$calendar$option.sort;
        ...
        subDomainSvgGroup
          ...
          .data(function (d) {
            ...
            if (sort3 === "desc") {
              var max6 = Math.max.apply(
                Math,
                _toConsumableArray(
                  subDomainsCollection.map(function (s2) {
                    return s2.x;
                  })
                )
              );
              ...
              return enter
                ...
                .call(function (selection2) {
                  return selection2
                    ...
                    .attr("class", function (d) {
                      return (
                        ...
                        __classPrivateFieldGet(
                          ...
                          _this,
                          d.t,
                          "".concat(DEFAULT_SELECTOR$1.slice(1), "-bg")
                        )
                      );
                    })
                    .attr("width", width)
                    ...
                    .attr("rx", radius2 > 0 ? radius2 : null)
                    .attr("ry", radius2 > 0 ? radius2 : null);
                })
                .call(function (selection2) {
                  return __classPrivateFieldGet(
                    _this,
...
(_SubDomainPainter_instances = /* @__PURE__ */ new WeakSet()),
  (_SubDomainPainter_setPositions = function _SubDomainPainter_setPositions2(
    selection2
  ) {
    var options = this.calendar.options.options;
    var _options$domain = options.domain,
      padding = _options$domain.padding,
      position2 = _options$domain.label.position;
    selection2
      .attr("x", function () {
  ...
  (_SubDomainPainter_classname = function _SubDomainPainter_classname2(
    timestamp
  ) {
    var _this2 = this;
    var _this$calendar$option2 = this.calendar.options.options,
      highlight = _this$calendar$option2.date.highlight,
      type2 = _this$calendar$option2.subDomain.type;
    var classname = "";
    ...
    for (
      var _len = arguments.length,
        otherClasses = new Array(_len > 1 ? _len - 1 : 0),
        _key = 1;
      _key < _len;
      _key++
    ) {
      ...
      .attr("class", function (d) {
        return (
          ...
          __classPrivateFieldGet(
            ...
            "m",
            _SubDomainPainter_classname
          ).call(_this3, d.t, "".concat(DEFAULT_SELECTOR$1.slice(1), "-text"))
        );
      })
      .attr("x", function (d) {
        return (
  ...
  (_SubDomainPainter_getCoordinates =
    function _SubDomainPainter_getCoordinates2(axis, d) {
  ...
  _createClass(DomainsContainerPainter2, [
    {
      ...
      value: function setup() {
        this.root = this.calendar.calendarPainter.root
          ...
          .attr(
            "class",
            "".concat(BASE_SELECTOR.slice(1), "-animation-wrapper")
          );
      },
    },
    {
      ...
      value: function paint(scrollDirection) {
        ...
        __classPrivateFieldGet(
          this,
          _DomainsContainerPainter_instances,
          "m",
          _DomainsContainerPainter_startAnimation
        ).call(this);
        ...
        __classPrivateFieldGet(
          ...
          _DomainsContainerPainter_instances,
          "m",
          _DomainsContainerPainter_recomputeDimensions
        ).call(this);
        Promise.allSettled(result).then(function () {
          __classPrivateFieldGet(
            ...
            _DomainsContainerPainter_instances,
            "m",
            _DomainsContainerPainter_endAnimation
          ).call(_this);
        });
        return result;
      },
    },
    {
      ...
      value: function updatePosition() {
        var _a;
        if (
          !((_a = this.root) === null || _a === void 0 ? void 0 : _a.node())
        ) {
        ...
        return [
          select_default2(this.root.node().parentNode)
            .transition()
...
(_DomainsContainerPainter_instances = /* @__PURE__ */ new WeakSet()),
  (_DomainsContainerPainter_startAnimation =
    function _DomainsContainerPainter_startAnimation2() {
      var _a;
      if ((_a = this.root) === null || _a === void 0 ? void 0 : _a.node()) {
        this.transitionsQueueCount += 1;
        select_default2(this.root.node().parentNode).classed(
  ...
  (_DomainsContainerPainter_endAnimation =
    function _DomainsContainerPainter_endAnimation2() {
      var _a;
      if ((_a = this.root) === null || _a === void 0 ? void 0 : _a.node()) {
        this.transitionsQueueCount -= 1;
  ...
  (_DomainsContainerPainter_recomputeDimensions =
    function _DomainsContainerPainter_recomputeDimensions2() {
      var _this$calendar$option = this.calendar.options.options,
  ...
  _createClass(PluginPainter2, [
    ...
    },
    {
      ...
      value: function setPluginsPosition() {
        ...
        var animationDuration = this.calendar.options.options.animationDuration;
        var domainsContainerPainter =
          this.calendar.calendarPainter.domainsContainerPainter;
  ...
  _createClass(CalendarPainter2, [
    {
      ...
      value: function setup() {
        ...
        if (!this.root) {
          this.root = select_default2(itemSelector)
            .append("svg")
      ...
      value: function paint() {
        var navigationDir =
          arguments.length > 0 && arguments[0] !== void 0
            ? arguments[0]
            : ScrollDirection.SCROLL_NONE;
        var transitions = this.domainsContainerPainter
          .paint(navigationDir)
          .concat(this.pluginPainter.paint())
          .concat(this.domainsContainerPainter.updatePosition());
        __classPrivateFieldGet(
          this,
          _CalendarPainter_instances,
          "m",
          _CalendarPainter_resize
        ).call(this);
    ...
    },
    {
      key: "destroy",
      value: function destroy() {
        var result = this.calendar.pluginManager
          .destroyAll()
...
(_CalendarPainter_instances = /* @__PURE__ */ new WeakSet()),
  (_CalendarPainter_getHeight = function _CalendarPainter_getHeight2() {
    return (
  ...
  (_CalendarPainter_resize = function _CalendarPainter_resize2() {
    var options = this.calendar.options.options;
    var newWidth = __classPrivateFieldGet(
      this,
      _CalendarPainter_instances,
      "m",
      _CalendarPainter_getWidth
    ).call(this);
    var newHeight = __classPrivateFieldGet(
      this,
      _CalendarPainter_instances,
      "m",
      _CalendarPainter_getHeight
    ).call(this);
    this.root
      .transition()
...
$$3(
  ...
  },
  {
    startsWith: function startsWith(searchString) {
      ...
      var index2 = toLength$1(
        min$1(arguments.length > 1 ? arguments[1] : void 0, that.length)
      );
      var search = toString$4(searchString);
      return nativeStartsWith
        ? nativeStartsWith(that, search, index2)
        : stringSlice$3(that, index2, index2 + search.length) === search;
    },
  }
);
...
var createMethod = function (TO_ENTRIES) {
  return function (it) {
    ...
    while (length2 > i) {
      ...
      if (
        !DESCRIPTORS$1 ||
        (IE_WORKAROUND ? key in O : propertyIsEnumerable$2(O, key))
      ) {
...
function coerceNumbers(values2) {
  return values2 instanceof TypedArray
    ? values2
    : map5(values2, coerceNumber, Float64Array);
}
...
function coerceDate(x3) {
  return x3 instanceof Date && !isNaN(x3)
    ? x3
    : typeof x3 === "string"
    ? parse(x3)
    : x3 == null || isNaN((x3 = +x3))
...
function arrayify(data2) {
  return data2 == null || data2 instanceof Array || data2 instanceof TypedArray
    ? data2
    : Array.from(data2);
}
function map5(values2, f, type2 = Array) {
  return values2 == null
    ? values2
    : values2 instanceof type2
    ? values2.map(f)
    : type2.from(values2, f);
}
...
function isScaleOptions(option) {
  return (
    isObject(option) && (option.type !== void 0 || option.domain !== void 0)
  );
}
  ...
  if (typeof interval2 === "number") {
    ...
    return interval2 < 0
      ? {
          ...
          range: (lo, hi) =>
            range(Math.ceil(lo * n), hi * n).map((x3) => x3 / n),
        }
      : {
          floor: (d) => Math.floor(d / n) * n,
          offset: (d) => d + n,
...
function scheme11r(scheme28, interpolate) {
  return ({ length: n }) => {
    ...
    n = Math.max(3, Math.floor(n));
    return n > 11
      ? quantize_default((t) => interpolate(1 - t), n)
      : scheme28[n].slice().reverse();
  };
}
...
function createScaleQ(
  ...
  channels,
  {
    ...
    scheme: scheme28,
    interval: interval2,
    range: range3 = registry.get(key) === radius
      ...
      ? unit2
      : void 0,
    interpolate = registry.get(key) === color2
      ? scheme28 == null && range3 !== void 0
        ? rgb_default
        : quantitativeScheme(
            scheme28 !== void 0
              ? scheme28
  ...
  if (interpolate.length === 1) {
    ...
    scale3.interpolate(
      (range3 === unit2 ? constant$1 : interpolatePiecewise)(interpolate)
    );
  } else {
...
function createScaleSqrt(key, channels, options) {
  return createScalePow(
    key,
    channels,
    __spreadProps(__spreadValues({}, options), { exponent: 0.5 })
  );
}
function createScalePow(key, channels, _a) {
  var _b = _a,
    { exponent: exponent2 = 1 } = _b,
    options = __objRest(_b, ["exponent"]);
  return createScaleQ(
    key,
    pow2().exponent(exponent2),
    channels,
    __spreadProps(__spreadValues({}, options), { type: "pow" })
  );
}
function createScaleLog(key, channels, _a) {
  var _b = _a,
    { base = 10, domain = inferLogDomain(channels) } = _b,
    options = __objRest(_b, ["base", "domain"]);
  return createScaleQ(
    key,
    log2().base(base),
    channels,
    __spreadProps(__spreadValues({}, options), { domain })
  );
}
function createScaleSymlog(key, channels, _a) {
  var _b = _a,
    { constant: constant3 = 1 } = _b,
    options = __objRest(_b, ["constant"]);
...
function createScaleQuantile(
  ...
  if (range3 === void 0) {
    range3 =
      interpolate !== void 0
        ? quantize_default(interpolate, n)
        : registry.get(key) === color2
        ? ordinalRange(scheme28, n)
        : void 0;
  }
  if (domain.length > 0) {
    domain = quantile2(
      domain,
      range3 === void 0 ? { length: n } : range3
    ).quantiles();
  }
...
function createScaleQuantize(
  ...
  if (range3 === void 0) {
    ...
    thresholds = quantize_default(number_default(min5, max6), n + 1).slice(
      1,
      -1
    );
...
function createScaleThreshold(
  ...
  channels,
  {
    ...
    scheme: scheme28 = "rdylbu",
    interpolate,
    range: range3 = interpolate !== void 0
      ? quantize_default(interpolate, domain.length + 1)
      : registry.get(key) === color2
      ? ordinalRange(scheme28, domain.length + 1)
      : void 0,
    reverse: reverse$1,
  }
) {
  ...
  return {
    type: "threshold",
    scale: threshold(
      sign3 < 0 ? reverse(domain) : domain,
      range3 === void 0 ? [] : range3
    ).unknown(unknown),
    domain,
    range: range3,
  };
...
function inferAutoDomain(key, channels) {
  ...
  return (
    type2 === radius || type2 === opacity || type2 === length
      ? inferZeroDomain
      : inferDomain$1
  )(channels);
}
function inferZeroDomain(channels) {
  return [
    ...
    channels.length
      ? max(channels, ({ value }) =>
          value === void 0 ? value : max(value, finite)
        )
      : 1,
  ];
}
...
function createScaleD(
  ...
  channels,
  {
    ...
    interpolate = registry.get(key) === color2
      ? scheme28 == null && range3 !== void 0
        ? rgb_default
        : quantitativeScheme(scheme28 !== void 0 ? scheme28 : "rdbu")
      : number_default,
    reverse: reverse2,
  }
) {
  ...
  if (range3 !== void 0) {
    interpolate =
      interpolate.length === 1
        ? interpolatePiecewise(interpolate)(...range3)
        : piecewise(interpolate, range3);
  }
...
function createScaleDivergingSqrt(key, channels, options) {
  return createScaleDivergingPow(
    key,
    channels,
    __spreadProps(__spreadValues({}, options), { exponent: 0.5 })
  );
...
function createScaleDivergingPow(key, channels, _a) {
  ...
  return createScaleD(
    key,
    divergingPow().exponent((exponent2 = +exponent2)),
    transformPow2(exponent2),
    channels,
...
function createScaleDivergingLog(key, channels, _a) {
  var _b = _a,
    ...
    options = __objRest(_b, ["base", "pivot", "domain"]);
  return createScaleD(
    key,
    divergingLog().base((base = +base)),
    transformLog2,
    channels,
    __spreadValues(
      {
...
function createScaleOrdinal(key, channels, _a) {
  ...
  if (registry.get(key) === symbol) {
    ...
    range3 =
      range3 === void 0 ? inferSymbolRange(hint) : map5(range3, maybeSymbol);
  } else if (registry.get(key) === color2) {
    if (
      range3 === void 0 &&
      (type2 === "ordinal" || type2 === ordinalImplicit)
    ) {
...
function createScalePoint(key, channels, _a) {
  var _b = _a,
    { align = 0.5, padding = 0.5 } = _b,
    options = __objRest(_b, ["align", "padding"]);
  return maybeRound(
    point().align(align).padding(padding),
    channels,
    options,
    key
  );
...
function normalizeScale(key, scale3, hint) {
  return createScale(
    key,
    hint === void 0 ? void 0 : [{ hint }],
    __spreadValues({}, scale3)
  );
}
function createScale(key, channels = [], options = {}) {
  ...
  if (
    options.type === void 0 &&
    options.domain === void 0 &&
    options.range === void 0 &&
    options.interval == null &&
    key !== "fx" &&
    key !== "fy" &&
    isOrdinalScale({ type: type2 })
  ) {
    const values2 = channels
      .map(({ value }) => value)
...
function isOrdinalScale({ type: type2 }) {
  return (
    ...
    type2 === "point" ||
    type2 === "band" ||
    type2 === ordinalImplicit
  );
}
function coerceType(channels, _a, coerceValues) {
  var _b = _a,
    { domain } = _b,
    options = __objRest(_b, ["domain"]);
  ...
  try {
    ...
    return scale2(
      _defineProperty(
        {},
        scaleType,
        Object.assign(Object.assign({}, scaleOptions[scaleType]), {
          clamp: true,
        })
      )
    );
  ...
  if (scaleOptions.hasOwnProperty("opacity")) {
    ...
    styles.fill = function (d) {
      return (
        // eslint-disable-next-line implicit-arrow-linebreak
        typeof d === "string" &&
          (d === null || d === void 0 ? void 0 : d.startsWith("#"))
          ? d
          : _scale === null || _scale === void 0
          ? void 0
          : _scale.apply(d)
      );
    };
  ...
  _createClass(Populator2, [
    {
      ...
      value: function populate() {
        ...
        var _calendar$options$opt = calendar2.options.options,
          scale3 = _calendar$options$opt.scale,
          subDomain = _calendar$options$opt.subDomain;
        var colorScale = normalizedScale(scale3);
        calendar2.calendarPainter.root
          .selectAll(".ch-domain")
          .selectAll("svg")
          .selectAll("g")
          .data(function (d) {
          ...
          .call(function (element) {
            element
              ...
              .attr("style", function (d) {
                var defaultColor =
                  hcl(
                    colorScale === null || colorScale === void 0
                      ? void 0
                      : colorScale.apply(d.v)
                  ).l > 60
                    ? "#000"
                    : "#fff";
...
var stringToPath = memoizeCapped(function (string) {
  ...
  string.replace(rePropName, function (match2, number5, quote, subString) {
    result.push(
      quote ? subString.replace(reEscapeChar, "$1") : number5 || match2
    );
  });
  return result;
});
  ...
  _createClass(Options2, [
    {
      ...
      value: function set$12(key, value) {
        if (
          !has(this.options, key) ||
          isEqual(get3(this.options, key), value)
        ) {
          return false;
        }
        set3(
          ...
          has(this.preProcessors, key)
            ? get3(this.preProcessors, key)(value)
            : value
        );
        return true;
      },
    },
    {
      ...
      value: function init2(opts) {
        ...
        this.options = Object.assign(
          {},
          mergeWith$1(this.options, opts, function (_, srcValue) {
        ...
        Object.keys(this.preProcessors).forEach(function (key) {
          set3(
            options,
            key,
            get3(_this.preProcessors, key)(get3(options, key))
          );
        });
  ...
  patchedExec = function exec2(string) {
    ...
    if (sticky) {
      ...
      if (
        re3.lastIndex > 0 &&
        (!re3.multiline ||
          (re3.multiline && charAt$2(str, re3.lastIndex - 1) !== "\n"))
      ) {
        source = "(?: " + source + ")";
        strCopy = " " + strCopy;
        charsAdded++;
    ...
    return [
      ...
      function replace2(searchValue, replaceValue) {
        ...
        return replacer
          ...
          : call(nativeReplace2, toString$1(O), searchValue, replaceValue);
      },
      ...
      function (string, replaceValue) {
        ...
        for (var i = 0; i < results.length; i++) {
          ...
          var position2 = max5(
            min4(toIntegerOrInfinity(result.index), S.length),
            0
          );
          var captures = [];
          var replacement2;
          ...
          if (position2 >= nextSourcePosition) {
            accumulatedResult +=
              stringSlice(S, nextSourcePosition, position2) + replacement2;
                  ...
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      return _context.abrupt(
                        ...
                        __classPrivateFieldGet(
                          this,
                          _DataFetcher_instances,
                          "m",
                          _DataFetcher_fetch
                        ).call(this, source, startTimestamp, endTimestamp)
                      );
                    case 2:
                      d = [];
...
(_DataFetcher_instances = /* @__PURE__ */ new WeakSet()),
  (_DataFetcher_fetch = function _DataFetcher_fetch2(
    source,
    startTimestamp,
    endTimestamp
  ) {
      ...
      v2 = {
        ...
        m: function t4(e3, n2) {
          ...
          var r2 = 12 * (n2.year() - e3.year()) + (n2.month() - e3.month()),
            i2 = e3.clone().add(r2, c4),
            s3 = n2 - i2 < 0,
            u5 = e3.clone().add(r2 + (s3 ? -1 : 1), c4);
        ...
        p: function (t4) {
          return (
            { M: c4, y: h, w: o, d: a2, D: d, h: u4, m: s2, s: i, ms: r, Q: f }[
              t4
            ] ||
            String(t4 || "")
              .toLowerCase()
        ...
        return (
          ...
          (m2.startOf = function (t4, e3) {
            var n2 = this,
              ...
              l2 = function (t5, e4) {
                var i2 = b.w(
                  n2.$u ? Date.UTC(n2.$y, e4, t5) : new Date(n2.$y, e4, t5),
                  n2
                );
          ...
          (m2.add = function (r2, f2) {
            ...
            if ($3 === o) return y4(7);
            var M4 =
                ((d2 = {}), (d2[s2] = e), (d2[u4] = n), (d2[i] = t), d2)[$3] ||
                1,
  ...
  !(function (e, t) {
    ...
    return function (e, t) {
      t.prototype.weekday = function (e3) {
        var t4 = this.$locale().weekStart || 0,
          i = this.$W,
          n = (i < t4 ? i + 7 : i) - t4;
    ...
    return function (t, i, s2) {
      ...
      (d.isoWeekYear = function () {
        ...
        (d.isoWeek = function (t4) {
          ...
          var i2,
            ...
            u4 =
              ((i2 = this.isoWeekYear()),
              (d2 = this.$u),
              (n2 = (d2 ? s2.utc : s2)().year(i2).startOf("year")),
              (o = 4 - n2.isoWeekday()),
              n2.isoWeekday() > 4 && (o += 7),
              n2.add(o, e));
        ...
        (d.isoWeekday = function (e3) {
          return this.$utils().u(e3)
            ? this.day() || 7
            : this.day(this.day() % 7 ? e3 : e3 - 7);
        });
      var n = d.startOf;
      d.startOf = function (e3, t4) {
        var i2 = this.$utils(),
          s3 = !!i2.u(t4) || t4;
        return "isoweek" === i2.p(e3)
          ? s3
  ...
  !(function (t, i) {
    ...
    return function (s2, f, n) {
      ...
      u4.parse = function (t4) {
        t4.utc && (this.$u = true),
          this.$utils().u(t4.$offset) || (this.$offset = t4.$offset),
          o.call(this, t4);
      };
      var r = u4.init;
      u4.init = function () {
      ...
      u4.utcOffset = function (s3, f2) {
        ...
        if (
          ...
          return this;
        var u5 = Math.abs(s3) <= 16 ? 60 * s3 : s3,
          o2 = this;
        ...
        if (0 !== s3) {
          var r2 = this.$u
            ...
            : -1 * this.utcOffset();
          ((o2 = this.local().add(u5 + r2, t)).$offset = u5),
            (o2.$x.$localOffset = r2);
        } else o2 = this.utc();
        return o2;
      };
      ...
      (u4.format = function (t4) {
        ...
        (u4.valueOf = function () {
          var t4 = this.$utils().u(this.$offset)
            ? 0
            : this.$offset +
    ...
    return function (n, i, o) {
      ...
      (f.tz = function (t4, e3) {
        ...
        var n2 = this.utcOffset(),
          i2 = this.toDate(),
          a3 = i2.toLocaleString("en-US", { timeZone: t4 }),
          u5 = Math.round((i2 - new Date(a3)) / 1e3 / 60),
          f2 = o(a3, { locale: this.$L })
            .$set("millisecond", this.$ms)
            .utcOffset(
              15 * -Math.round(i2.getTimezoneOffset() / 15) - u5,
              true
            );
        if (e3) {
          var s3 = f2.utcOffset();
        ...
        (f.offsetName = function (t4) {
          var e3 = this.$x.$timezone || o.tz.guess(),
            n2 = a2(this.valueOf(), e3, { timeZoneName: t4 }).find(function (
              t5
            ) {
      ...
      (f.startOf = function (t4, e3) {
        ...
        (o.tz = function (t4, e3, n2) {
          ...
          var s3 = (function (t5, e4, n3) {
              ...
              return o2 === r2
                ? [i3, o2]
                : [t5 - 60 * Math.min(o2, r2) * 1e3, Math.max(o2, r2)];
            })(o.utc(t4, i2).valueOf(), f2, a3),
            m = s3[0],
            c4 = s3[1],
            d = o(m).utcOffset(c4);
        ...
        s2 = function () {
          ...
          return {
            ...
            weekdaysMin: function (e3) {
              return e3
                ? e3.format("dd")
                : u4(n2, "weekdaysMin", "weekdays", 2);
            },
            weekdaysShort: function (e3) {
              return e3
                ? e3.format("ddd")
                : u4(n2, "weekdaysShort", "weekdays", 3);
            },
  ...
  !(function (e, n) {
    ...
    return function (e, n, t) {
      t.updateLocale = function (e3, n2) {
        ...
        if (o)
          return (
            (n2 ? Object.keys(n2) : []).forEach(function (e4) {
              o[e4] = n2[e4];
            }),
            o
          );
  ...
  _createClass(DateHelper2, [
                    ...
                    case 17:
                      if (_typeof(userLocale) === "object") {
                        if (userLocale.hasOwnProperty("name")) {
                          ...
                          this.locale = dayjs.updateLocale(
                            DEFAULT_LOCALE,
                            userLocale
                          );
                        }
    ...
    },
    {
      ...
      value: function loadBrowserLocale(userLocale) {
        return new Promise(function (resolve2, reject2) {
          ...
          s2.async = true;
          s2.src = "https://cdn.jsdelivr.net/npm/dayjs@1/locale/".concat(
            userLocale,
            ".js"
          );
    ...
    },
    {
      ...
      value: function loadNodeLocale(userLocale) {
        return import(
          /* @vite-ignore */ "dayjs/locale/".concat(userLocale, ".js")
        );
      },
    },
  ]);
...
function validate(templateCollection, _ref) {
  ...
  if (!templateCollection.has(subDomainType)) {
    throw new Error(
      "'".concat(subDomainType, "' is not a valid subDomain type'")
    );
  }
  if (data2.type && !ALLOWED_DATA_TYPES.includes(data2.type)) {
    throw new Error(
      "The data type '".concat(data2.type, "' is not valid data type")
    );
  }
  if (
    ...
    throw new Error(
      ...
      ) + "with the domain type ".concat(domainType)
    );
  }
  return true;
}
  ...
  _createClass(PluginManager2, [
    {
      ...
      value: function add2(plugins) {
        ...
        plugins.forEach(function (_ref) {
          ...
          if (
            existingPlugin &&
            _this.settings.get(name) &&
            isEqual(_this.settings.get(name).options, pluginOptions)
          ) {
            return;
          }
    ...
    },
    {
      ...
      value: function getFromPosition(position2) {
        return this.allPlugins().filter(function (plugin) {
          var _a;
          return (
            ((_a = plugin.options) === null || _a === void 0
              ? void 0
              : _a.position) === position2
          );
        });
      },
    },
    {
      ...
      value: function getHeightFromPosition(position2) {
        return this.getFromPosition(position2)
          .map(function (d) {
...
var minuteTemplate = function minuteTemplate2(DateHelper2) {
  ...
  return {
    ...
    mapping: function mapping(startTimestamp, endTimestamp) {
      return (
        // eslint-disable-next-line implicit-arrow-linebreak
        DateHelper2.intervals(
          "minute",
          startTimestamp,
          DateHelper2.date(endTimestamp)
        ).map(function (ts, index2) {
          return {
            t: ts,
      ...
      switch (domain.type) {
        ...
        case "month":
          return (
            ...
            (domain.dynamicDimension ? DateHelper2.date(ts).daysInMonth() : 31)
          );
        case "day":
        default:
        ...
        case "month":
          return Math.ceil(
            domain.dynamicDimension && !verticalOrientation
              ? DateHelper2.getMonthWeekNumber(
                  DateHelper2.date(ts).endOf("month")
                )
              : 6
          );
        case "year":
          return Math.ceil(
            domain.dynamicDimension
              ? DateHelper2.date(ts).endOf("year").dayOfYear() / ROWS_COUNT
              : 54
          );
        case "week":
        default:
    ...
    rowsCount: function rowsCount(ts) {
      switch (domain.type) {
        ...
        case "year":
          return Math.ceil(
            domain.dynamicDimension
              ? DateHelper2.date(ts).endOf("year").dayOfYear() / COLUMNS_COUNT
              : 54
          );
        case "week":
        default:
...
var dayTemplate3 = function dayTemplate4(DateHelper2) {
  ...
  return {
    ...
    mapping: function mapping(startTimestamp, endTimestamp) {
      ...
      return DateHelper2.intervals("day", clampStart, clampEnd).map(function (
        ts
      ) {
...
var weekTemplate = function weekTemplate2(DateHelper2, _ref) {
  ...
  return {
      ...
      switch (domain.type) {
        case "year":
          return domain.dynamicDimension
            ? DateHelper2.date(ts).endOf("year").isoWeeksInYear()
            : 53;
        case "month":
          return domain.dynamicDimension
            ? DateHelper2.getWeeksCountInMonth(ts)
            : 5;
        default:
          return 1;
      }
    ...
    mapping: function mapping(startTimestamp, endTimestamp) {
      var clampStart = DateHelper2.getFirstWeekOfMonth(startTimestamp);
      var clampEnd = DateHelper2.getFirstWeekOfMonth(endTimestamp);
      return DateHelper2.intervals("week", clampStart, clampEnd).map(function (
        ts,
        i
      ) {
        return {
    ...
    },
    {
      ...
      value: function add2(templates) {
        ...
        tplWithParent.forEach(function (name) {
          var parentTemplate = _this.settings.get(
            _this.settings.get(name).parent
          );
          if (!parentTemplate) {
            return;
          }
  ...
  _createClass(CalHeatmap2, [
    ...
    },
    {
      ...
      value: function next2() {
        ...
        var loadDirection = this.navigator.loadNewDomains(
          this.createDomainCollection(this.domainCollection.max, n + 1).slice(
            n
          ),
          ScrollDirection.SCROLL_FORWARD
        );
      ...
      value: function jumpTo(date2) {
        var reset =
          arguments.length > 1 && arguments[1] !== void 0
            ...
            : false;
        return Promise.allSettled([
          this.calendarPainter.paint(this.navigator.jumpTo(date2, reset)),
          this.fill(),
        ]);
      },
      /**
    ...
    },
    {
      ...
      value: function fill3() {
        ...
        var endDate = this.dateHelper.intervals(
          options.domain.type,
          this.domainCollection.max,
          2
        )[1];
        var dataPromise = this.dataFetcher.getDatas(
          dataSource,
